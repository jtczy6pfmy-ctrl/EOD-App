...
// MAD MARTIAN STUDIOS MILESTONE COLORS
const MILESTONES={
 7:{
  icon:"🎯",
  title:"25% COMPLETE!",
  subtitle:"7 / 28 INSPECTIONS",
  color:"#22B7F0"
 },
 14:{
  icon:"👽",
  title:"50% COMPLETE!",
  subtitle:"14 / 28 INSPECTIONS",
  color:"#65D64A"
 },
 21:{
  icon:"⚡",
  title:"75% COMPLETE!",
  subtitle:"21 / 28 INSPECTIONS",
  color:"#FF7A35"
 },
 28:{
  icon:"🏆",
  title:"DAILY TARGET COMPLETE!",
  subtitle:"28 / 28 INSPECTIONS",
  color:"#F04B32"
 }
};
...
function showInTerminal(m){
 ...
 // Mad Martian dark space background with milestone color
